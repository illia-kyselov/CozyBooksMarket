...
const styles = StyleSheet.create({
    ...
    formatBtnBase: { width: 165, height: 47, borderRadius: 30, alignItems: 'center', justifyContent: 'center' },
    formatBtnActive: { backgroundColor: COLORS.yellow, borderWidth: 0 },
    formatBtnInactive: { backgroundColor: COLORS.transparent, borderWidth: 1, borderColor: COLORS.yellow },
    formatBtnTextBase: {
        fontFamily: 'SFPro-Regular',
        fontSize: 24,
        letterSpacing: -0.32,
