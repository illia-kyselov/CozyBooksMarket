...
const styles = StyleSheet.create({
    ...
    activeBtn: { backgroundColor: '#FCFF3C' },
    inactiveBtn: { borderWidth: 1, borderColor: '#FCFF3C' },
    currencyText: {
        fontFamily: 'SFPro-Regular',
        fontSize: 18,
        letterSpacing: -0.32,
    ...
    regionActive: { backgroundColor: '#FCFF3C' },
    regionInactive: { borderWidth: 1, borderColor: '#FCFF3C' },
    regionText: {
        fontFamily: 'SFPro-Regular',
        fontSize: 17,
        letterSpacing: -0.32,
    ...
    regionInactiveText: { color: '#FCFF3C' },
});
